...
//电话号码 (位数不限制，例子：400-800-5555，15112341234，0571-88888888，0217894563)
jQuery.validator.addMethod("telephone", function(value, element){
	if(value==null||value==undefined||value=="" ){return true};
	var patrn=/^[0-9][0-9]*[\-]?[0-9]*[\-]?[0-9]*[0-9]$/;
	if (!patrn.exec(value.replace(/[ ]/g,""))) return false
	return true
});
//手机
...
//社会信用号验证     91350100M000100Y43  测试
//$.validator.addMethod("socialCreditValidate",function(val,element){
...
//	var pre17=value.substring(0,17);
//	var sum=0;
//	for(var i=0;i<pre17.length;i++){
//		sum+=power[i]*code.indexOf(pre17[i]);
//	}
//	var temp=sum%31;
//	temp=(temp==0?31:temp);
//	return value[17]==code[31-temp]?true:false;
//	
//	return this.optional(element) ||/^[a-zA-Z0-9]+$/.test(val);
//});
